...
impl Runtime {
    ...
    fn spwan(&mut self, future: impl Future<Output = usize> + 'static) -> JoinHandle { // why 'static
        let join_inner = JoinHandleInner { ret: None, waker: None };
